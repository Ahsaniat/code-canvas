...
## Note
First of all I give thanks to the original author waLLxAck. I have forked his source code for this extension and added support for VScode later versions. I have also optimized and added new features, while improving usability of the extension. You might see build files here. I have git committed them intentionally as a fallback. I have tested it extensively on VScode 1.129.1, extension engine 1.102+. Version lesser than this might not work with this extension. You can report any bug(s) or ask for new features. Even though the extension is under development and more features will be coming next month, the master is the stable release branch and you are welcome to try it!
